...
int main(int /*argc*/, char** /*argv*/)
{
    ...
    {       
        printf( "EmbeddedInfo.timestamp.available = true\n" );
        embeddedInfo.timestamp.onOff = true;
    } else {
        printf( "EmbeddedInfo.timestamp.available = false\n" );
    }

    if ( embeddedInfo.frameCounter.available != 0 )
    {       
        printf( "EmbeddedInfo.frameCounter.available = true\n" );
        embeddedInfo.frameCounter.onOff = true;
    } else {
        printf( "EmbeddedInfo.frameCounter.available = false\n" );
    }
